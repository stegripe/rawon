    ...
    <Popover className="relative bg-white dark:bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 dark:border-gray-700 py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex md:justify-start space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-white dark:bg-black rounded-md inline-flex items-center text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                    )}
                  >
                    <span className="dark:text-white hover:text-gray-900 dark:hover:text-gray-400">Tools</span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className={classNames(
            ...
            <a href="https://github.com/zhycorp/disc-11" className="text-base font-medium text-gray-500 dark:text-white dark:hover:text-gray-400 hover:text-gray-900">
              Github
            </a>
          </Popover.Group>
        </div>
