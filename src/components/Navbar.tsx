    ...
    <Popover className="bg-white dark:bg-black">
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex items-center justify-between h-16">
            ...
            <Popover.Group as="div" className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Popover className="relative">
                  {({ open }) => (
                  <>
                    <Popover.Button className={classNames( open ? "text-gray-900" : "text-gray-500"
                      ...
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className={classNames( open
                        ? "text-gray-600" : "text-gray-400" , "ml-2 h-5 w-5 group-hover:text-gray-500" )}
                        aria-hidden="true">
          ...
          <div className="-mr-2 flex md:hidden">
            <Popover.Button
              className="bg-white dark:bg-black text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:text-gray-400 dark:hover:bg-gray-900 inline-flex items-center justify-center p-2 rounded-md focus:outline-none">
      ...
      <Transition as={Fragment} enter="duration-200 ease-out" enterFrom="opacity-0 scale-95"
        ...
        <Popover.Panel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
          <div
            className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white dark:bg-black divide-y-2 divide-gray-50">
            <div className="pt-5 pb-6 px-5">
              <div className="flex items-center justify-between">
                ...
                <div className="-mr-2">
                  <Popover.Button
                    className="bg-white dark:bg-black rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:text-gray-400 dark:hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
