...
export class RepeatCommand extends BaseCommand {
    ...
    public execute(message: IMessage, args: string[]): any {
        ...
        message.channel.send(createEmbed("error", `Invalid usage, see **\`${this.client.config.prefix}help ${this.meta.name}\`** for more information`)).catch(e => this.client.logger.error("REPEAT_CMD_ERR:", e));
    }
}
