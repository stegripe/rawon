...
export const disableSongSelection = process.env.CONFIG_DISABLE_SONG_SELECTION === "no";
...
export const cacheYoutubeDownloads: boolean = process.env.CONFIG_CACHE_YOUTUBE_DOWNLOADS === "no";
...
export const debug = process.env.CONFIG_DEBUG === "no";
export const status = {
...
export const fetchAllUsers = process.env.CONFIG_FETCH_ALL_USERS === "no";
