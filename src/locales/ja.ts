    ...
    disclaimers: {
        ...
        copyright: {
            ...
            items: [
                ...
                "**ホスティングプロバイダーのポリシー：** 一部のホスティングプロバイダーは、DMCA保護されたコンテンツのホスティングまたは配布を禁止しています。これには、著作権で保護された音楽/ビデオを再生するDiscord音楽ボットが含まれます。このようなプラットフォームへのデプロイは自己責任で行ってください。",
