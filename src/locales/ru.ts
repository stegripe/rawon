    ...
    gettingStarted: {
        ...
        features: {
            ...
            items: [
                ...
                "🤖 Запуск нескольких экземпляров бота для разных голосовых каналов",
                "⚡ Умное предварительное кэширование аудио для более плавного воспроизведения",
                "🎶 Поддержка нескольких музыкальных платформ (видеосайты, Spotify, SoundCloud)",
                "🔄 Многокукиная ротация для бесперебойного воспроизведения"
            ]
        },
        requirements: {
            title: "Требования",
        ...
        standardSetup: {
            ...
            steps: [
                ...
                "Скопируйте `.env.example` в `.env` и заполните необходимые значения (минимум: `DISCORD_TOKEN`)",
        ...
        dockerSetup: {
            ...
            volumeInfo: {
                ...
                items: [
                    ...
                    "`data.*` для постоянных настроек (каналы запросов, состояния плеера)",
                    "Кэшированные аудиофайлы (если кэширование аудио включено)",
                    "Файлы cookie для аутентификации видеоплатформы"
                ]
            }
        },
    ...
    disclaimers: {
        ...
        copyright: {
            ...
            items: [
                ...
                "**Политики хостинг-провайдеров:** Некоторые хостинг-провайдеры запрещают размещение или распространение контента, защищенного DMCA. Это включает музыкальных ботов Discord, воспроизводящих защищенную авторским правом музыку/видео. Развертывание на таких платформах на ваш страх и риск.",
